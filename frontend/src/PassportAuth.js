...
const PassportAuth = () => {
  ...
  const [isCreate, setIsCreate] = useState(true); // State to toggle between Create and Verify components

  const contractAddress = '0x282949E11682cA1034417604E69aBE4422Cf5317';
  const contractABI = [
    {
      constant: true,
